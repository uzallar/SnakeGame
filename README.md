...
# ViewModel
## SnakeGameViewModel.cs - Основная ViewModel игры (команды, привязка данных)
...
|-----------------------|-----------------------------------|---------------------------------|
|  UsernameTextBox    | Поле для ввода логина            |  Валидация при вводе          |
|  PasswordBox        | Поле для ввода пароля            |  Маскировка символов          |
|  Кнопка регистрации | Создание нового аккаунта         |  Ширина 220px                 |

🏆 Основные элементы LeaderboardWindow

| Элемент               | Тип                         | Особенности                     |
|-----------------------|-----------------------------|---------------------------------|
| LeaderboardListView   | `ListView`                  |  Основной элемент для отображения рейтинга |
|  GridView Columns     |`GridViewColumn`             | Колонки таблицы                       |
|  Header               | `TextBlock`                 | Заголовок "ТОП 10 ИГРОКОВ"            |
